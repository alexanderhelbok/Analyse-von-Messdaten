...
plt.plot(xi, test1(xi, param1[0], param1[1]), '--', color ='blue', label=r'Normal Fit $\ \chi^2 \approx 110$')
plt.plot(xi, test1(xi, param2[0], param2[1]), '--', color ='orange', label=r"Weighted Fit $\ \chi^2 \approx 23$")
...
print('\u03C7\u00b2 = {}, \u03C7\u00b2 = {}\n'.format(chisq(y, lit, alpha), chisq(y, avg, alpha)))
